...
public class DetailAdapter implements ListAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ImageView tvImage = (ImageView) layout
				.findViewById(R.id.messagegedetail_rov_icon);
	//	tvImage.setBackgroundResource(entity.getImageID());
		tvImage.setImageBitmap(entity.getImageID());
		return layout;
	}
